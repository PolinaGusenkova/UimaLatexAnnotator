 ...
 * @generated */
public class AccentVar_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (AccentVar_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = AccentVar_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new AccentVar(addr, AccentVar_Type.this);
  			   AccentVar_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new AccentVar(addr, AccentVar_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = AccentVar.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("latex.AccentVar");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "latex.AccentVar");
  ...
  public String getUpperIndex(int addr) {
      ...
      jcas.throwFeatMissing("upperIndex", "latex.AccentVar");
  ...
  public String getLowerIndex(int addr) {
      ...
      jcas.throwFeatMissing("lowerIndex", "latex.AccentVar");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public AccentVar_Type(JCas jcas, Type casType) {
    super(jcas, casType);
