 ...
 * @generated */
public class LetterVar_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (LetterVar_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = LetterVar_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new LetterVar(addr, LetterVar_Type.this);
  			   LetterVar_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new LetterVar(addr, LetterVar_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = LetterVar.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("latex.LetterVar");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "latex.LetterVar");
  ...
  public String getUpperIndex(int addr) {
      ...
      jcas.throwFeatMissing("upperIndex", "latex.LetterVar");
  ...
  public String getLowerIndex(int addr) {
      ...
      jcas.throwFeatMissing("lowerIndex", "latex.LetterVar");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public LetterVar_Type(JCas jcas, Type casType) {
    super(jcas, casType);
